...
df = pd.read_csv("???", names=['id', 'ccf', 'age', 'sex', 'painloc', 'painexer_(1_=_provoked_by_exertion;_0_=_otherwise)', 'relrest_(1_=_relieved_after_rest;_0_=_otherwise)', 'pncaden_(sum_of_5,_6,_and_7)', 'cp', 'trestbps', 'htn', 'chol', 'smoke', 'cigs_(cigarettes_per_day)', 'years_(number_of_years_as_a_smoker)', 'fbs', 'dm_(1_=_history_of_diabetes;_0_=_no_such_history)', 'famhist', 'restecg', 'ekgmo_(month_of_exercise_ECG_reading)', 'ekgday(day_of_exercise_ECG_reading)', 'ekgyr_(year_of_exercise_ECG_reading)', 'dig_(digitalis_used_furing_exercise_ECG', 'prop_(Beta_blocker_used_during_exercise_ECG', 'nitr_(nitrates_used_during_exercise_ECG', 'pro_(calcium_channel_blocker_used_during_exercise_ECG', 'diuretic_(diuretic_used_used_during_exercise_ECG', 'proto', 'thaldur', 'thaltime', 'met', 'thalach', 'thalrest', 'tpeakbps', 'tpeakbpd', 'dummy', 'trestbpd', 'exang', 'xhypo', 'oldpeak_=_ST_depression_induced_by_exercise_relative_to_rest', 'slope', 'rldv5', 'rldv5e', 'ca', 'restckm', 'exerckm', 'restef', 'restwm', 'exeref', 'exerwm', 'thal', 'thalsev', 'thalpul', 'earlobe', 'cmo', 'cday', 'cyr', 'num', 'lmt', 'ladprox', 'laddist', 'diag', 'cxmain', 'ramus', 'om1', 'om2', 'rcaprox', 'rcadist', 'lvx1', 'lvx2', 'lvx3', 'lvx4', 'lvf', 'cathef', 'junk', 'name'])
