...
#FROM URL 
"""
df = pd.read_csv("https://archive.ics.uci.edu/ml/machine-learning-databases/acute/diagnosis.data"
,delimiter='\s+'
,names=["patient_Temperature", "nausea_Occurrence", "Lumbar_pain", "Urine_pushing", "Micturition_pains", "urethra_outlet_urethra_itch_swelling", "nurinary_bladder_Inflammatio", "renal_pelvis_origin_Nephritis"])

print(df.info())
"""

#LOACL
df = pd.read_csv("../ics.uci.edu/ml/machine-learning-databases/acute/diagnosis.data"
,delimiter='\s+'
,names=["patient_Temperature", "nausea_Occurrence", "Lumbar_pain", "Urine_pushing", "Micturition_pains", "urethra_outlet_urethra_itch_swelling", "nurinary_bladder_Inflammatio", "renal_pelvis_origin_Nephritis"])
