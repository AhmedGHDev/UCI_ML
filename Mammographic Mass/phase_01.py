...
,names=['BI-RADS_assessment', 'Age', 'Shape', 'Margin', 'Density', 'Severity']
)
...
#LOACL
df = pd.read_csv('../ics.uci.edu/ml/machine-learning-databases/mammographic-masses/mammographic_masses.data'
,names=['BI-RADS_assessment', 'Age', 'Shape', 'Margin', 'Density', 'Severity']
)
