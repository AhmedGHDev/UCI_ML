...
"""
Abstract: Data was from a simulation of a servo system
...
"""
df = pd.read_csv("https://archive.ics.uci.edu/ml/machine-learning-databases/servo/servo.data",names=['motor', 'screw', 'pgain', 'vgain', 'class']
)
...
#LOACL
import pandas
df = pd.read_csv("../ics.uci.edu/ml/machine-learning-databases/servo/servo.data",names=['motor', 'screw', 'pgain', 'vgain', 'class']
)
